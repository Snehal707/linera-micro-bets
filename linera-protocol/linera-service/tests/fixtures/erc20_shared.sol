 ...
 * applications.
 */
contract ERC20_shared is Context, IERC20, IERC20Errors {
    mapping(address account => uint256) private _balances;

    mapping(address account => mapping(address spender => uint256)) private _allowances;

    uint256 private summed_total_supply; // total supply of all the chains.
    uint256 private _totalSupply; // total supply of this chain
