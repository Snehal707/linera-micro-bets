...
export type CustomMapView_Key_Post = {
  ...
  entries: Array<Entry_Key_Post_6913b126>
  entry: Entry_Key_Post_6913b126
  keys: Array<Key>
}

export type CustomMapView_Key_PostEntriesArgs = {
  input?: InputMaybe<MapInput_KeyInput_B8ccb225>
}
...
export type Entry_Key_Post_6913b126 = {
  __typename?: 'Entry_Key_Post_6913b126'
  key: Key
  value?: Maybe<Post>
}
...
export type LogView_OwnPost_22dbfca0 = {
  __typename?: 'LogView_OwnPost_22dbfca0'
  entries: Array<OwnPost>
}

export type LogView_OwnPost_22dbfca0EntriesArgs = {
  end?: InputMaybe<Scalars['Int']['input']>
  start?: InputMaybe<Scalars['Int']['input']>
}

export type MapFilters_KeyInput_B8ccb225 = {
  keys?: InputMaybe<Array<KeyInput>>
}

export type MapInput_KeyInput_B8ccb225 = {
  filters?: InputMaybe<MapFilters_KeyInput_B8ccb225>
}
...
export type SocialState = {
  __typename?: 'SocialState'
  /** Our posts. */
  ownPosts: LogView_OwnPost_22dbfca0
...
export type ReceivedPostsQuery = {
  __typename?: 'SocialState'
  receivedPosts: {
    __typename?: 'CustomMapView_Key_Post'
    entries: Array<{
      ...
      value?: {
        ...
        likes: number
        key: { __typename?: 'Key'; timestamp: any; author: any; index: number }
        comments: Array<{ __typename?: 'Comment'; text: string; chainId: any }>
      } | null
    }>
  }
}
...
export const ReceivedPostsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'ReceivedPosts' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<ReceivedPostsQuery, ReceivedPostsQueryVariables>
...
export const CommentOnPostDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CommentOnPost' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'key' } },
